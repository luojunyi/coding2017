...
public class GenericBinaryTreeTest {
    ...
    public void testAdd() {
        ...
        Assert.assertArrayEquals(new String[]{"1", "10", "17", "2", "3", "4", "5", "7", "9", "9" }, inorderDatas);
        String[] postorderDatas = binaryTree.traversal(GenericBinaryTree.POSTORDER, new String[0]);
        Assert.assertArrayEquals(new String[]{"17", "10", "3", "2", "1", "7", "5", "4", "9", "9" }, postorderDatas);
        String[] hierarchicalDatas = binaryTree.traversal(GenericBinaryTree.HIERARCHICAL, new String[0]);
        Assert.assertArrayEquals(new String[]{"9", "4", "9", "1", "5", "2", "7", "10", "3", "17" }, hierarchicalDatas);
    }
    ...
    public void testDelete() {
        ...
        Assert.assertArrayEquals(new Object[]{50, 25, 12, 14, 40, 35, 45, 44, 43, 42, 75, 55, 70, 60, 65, 63, 61, 90, 80, 85, 82, 88}, preOrderDatas);
        binaryTree.delete(88);
        preOrderDatas = binaryTree.traversal();
        Assert.assertArrayEquals(new Object[]{50, 25, 12, 14, 40, 35, 45, 44, 43, 42, 75, 55, 70, 60, 65, 63, 61, 90, 80, 85, 82}, preOrderDatas);

        // 删除一个子节点的节点
        binaryTree.delete(70);
        preOrderDatas = binaryTree.traversal();
        Assert.assertArrayEquals(new Object[]{50, 25, 12, 14, 40, 35, 45, 44, 43, 42, 75, 55, 60, 65, 63, 61, 90, 80, 85, 82}, preOrderDatas);
        binaryTree.delete(80);
        preOrderDatas = binaryTree.traversal();
        Assert.assertArrayEquals(new Object[]{50, 25, 12, 14, 40, 35, 45, 44, 43, 42, 75, 55, 60, 65, 63, 61, 90, 85, 82}, preOrderDatas);

        // 删除两个子节点的节点
        binaryTree.delete(40);
        preOrderDatas = binaryTree.traversal();
        Assert.assertArrayEquals(new Object[]{50, 25, 12, 14, 42, 35, 45, 44, 43, 75, 55, 60, 65, 63, 61, 90, 85, 82}, preOrderDatas);
        binaryTree.delete(50);
        preOrderDatas = binaryTree.traversal();
        Assert.assertArrayEquals(new Object[]{55, 25, 12, 14, 42, 35, 45, 44, 43, 75, 60, 65, 63, 61, 90, 85, 82}, preOrderDatas);
    }
