...
public class StrutsException extends RuntimeException {
	...
	public StrutsException(String paramString) {
		super(paramString);
		this.message = paramString;
		this.stackTrace = paramString;
	}
	
	public StrutsException(Throwable paramThrowable) {
	...
	public StrutsException(String paramString, Throwable paramThrowable) {
