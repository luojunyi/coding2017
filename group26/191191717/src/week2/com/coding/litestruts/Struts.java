...
public class Struts {
	 ...
	 * 
	 * 1. 鏍规嵁actionName鎵惧埌鐩稿搴旂殑class 锛� 渚嬪LoginAction,
	 * 閫氳繃鍙嶅皠瀹炰緥鍖栵紙鍒涘缓瀵硅薄锛� 鎹畃arameters涓殑鏁版嵁锛岃皟鐢ㄥ璞＄殑setter鏂规硶锛�
	 * 渚嬪parameters涓殑鏁版嵁鏄� ("name"="test" , "password"="1234") , 閭ｅ氨搴旇璋冪敤
	 * setName鍜宻etPassword鏂规硶
	 * 
	 * 2. 閫氳繃鍙嶅皠璋冪敤瀵硅薄鐨別xectue 鏂规硶锛� 骞惰幏寰楄繑鍥炲�硷紝渚嬪"success"
	 * 
	 * 3. 閫氳繃鍙嶅皠鎵惧埌瀵硅薄鐨勬墍鏈塯etter鏂规硶锛堜緥濡� getMessage锛�, 閫氳繃鍙嶅皠鏉ヨ皟鐢紝
	 * 鎶婂�煎拰灞炴�у舰鎴愪竴涓狧ashMap , 渚嬪 {"message": "鐧诲綍鎴愬姛"} ,
	...
	Set<String> set = parameters.keySet();// 鑾峰彇閿��
	...
	// Class clazz =
	// Class.forName("week2.com.coding.litestruts.LoginAction");
