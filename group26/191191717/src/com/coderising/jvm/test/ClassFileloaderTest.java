...
public class ClassFileloaderTest
{
    ...
    public void testClassFileLength()
    {
        ...
        // Ê≥®ÊÑèÔºöËøô‰∏™Â≠óËäÇÊï∞ÂèØËÉΩÂíå‰Ω†ÁöÑJVMÁâàÊú¨ÊúâÂÖ≥Á≥ªÔºå ‰Ω†ÂèØ‰ª•ÁúãÁúãÁºñËØëÂ•ΩÁöÑÁ±ªÂà∞Â∫ïÊúâÂ§öÂ§ß
    ...
    /**
     * Ê∂ìÂ¨ÆÊΩ∞ÈèÑÓàúÓÉáÊ∂ìÂ§ãÓÇºJVMÁíáÊÉßÁ∞≤ÁÄπÁÇµÂπáÈê®Âã¨Á•¥ÁíáÊõ†Êï§Ê∏öÔøΩ
     */
    @Test
...
public class ClassFileloaderTest
{
    ...
    static String path1 = "E:\\coding2017\\group26\\191191717\\bin";
    ...
    public void testClassFileLength()
    {
        ...
        // ◊¢“‚£∫’‚∏ˆ◊÷Ω⁄ ˝ø…ƒ‹∫Õƒ„µƒJVM∞Ê±æ”–πÿœµ£¨ ƒ„ø…“‘ø¥ø¥±‡“Î∫√µƒ¿‡µΩµ◊”–∂‡¥Û
        Assert.assertEquals(1056, byteCodes.length);
